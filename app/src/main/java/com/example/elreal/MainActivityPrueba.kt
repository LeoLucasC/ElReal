...
import com.example.elreal.databinding.ActivityMainPruebaBinding
...
class MainActivityPrueba : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_main_activity_prueba)
